namespace FunScript.Bindings.JSXGraph
...
type [<AllowNullLiteral>] Board =
    ...
    /// A reference to this boards renderer.
    abstract renderer: AbstractRenderer with get, set
...
and [<AllowNullLiteral>] GeometryElement =
    ...
    /// The string used with {@link Board#create}
    ...
    abstract addParents: parents: ResizeArray<obj option> -> Object
    /// <summary>Sets ids of elements to the array this.parents.
    /// First, this.parents is cleared. See {@link GeometryElement#addParents}.</summary>
    /// <param name="parents">- Array of elements or ids of elements.
    /// Alternatively, one can give a list of objects as parameters.</param>
    abstract setParents: parents: ResizeArray<obj option> -> Object
    ...
    /// <param name="transform">- Either one {@link Transformation}
    /// or an array of {@link Transformation}s.</param>
    ...
    /// Possible values are {@link COORDS_BY_USER} and {@link COORDS_BY_SCREEN}.</param>
    ...
    /// Deprecated alias for {@link GeometryElement#setAttribute}.
    ...
    /// Deprecated alias for {@link GeometryElement#getAttribute}.
    ...
    /// the renderer, to remove the element completely you should use {@link Board#removeObject}.
    ...
    /// <summary>Rotate texts or images by a given degree. Works only for texts where Text#display equal to "internal".</summary>
    ...
    /// The type of the element as used in {@link Board#create}.
    abstract getType: unit -> string
    /// List of the element ids resp. values used as parents in {@link Board#create}.
    ...
    /// as defined in their properties {@link Point#snapSizeX} and {@link Point#snapSizeY}. Lines and circles
    ...
    /// as defined in their properties {@link Point#attractorDistance} and {@link Point#attractorUnit}.
    /// Lines and circles
    ...
    /// to the background. Use {@link GeometryElement#clearTrace} to delete the trace elements.
    /// 
...
/// actually does not render anything. This is up to the {@link SVGRenderer}, {@link VMLRenderer},
/// and {@link CanvasRenderer} classes. We strongly discourage you from using the methods in these classes
/// directly. Only the methods which are defined in this class and are not marked as private are guaranteed
/// to exist in any renderer instance you can access via {@link Board#renderer}. But not all methods may
/// work as expected.</p>
/// <p>The methods of this renderer can be divided into different categories:
/// <dl>
///   <dt>Draw basic elements</dt>
///   <dd>In this category we find methods to draw basic elements like {@link Point}, {@link Line},
...
and [<AllowNullLiteral>] AbstractRenderer =
    ...
    /// <summary>Draws a point on the {@link Board}.</summary>
    /// <param name="el">- Reference to a {@link Point} object that has to be drawn.</param>
    abstract drawPoint: el: Point -> unit
    /// <summary>Updates visual appearance of the renderer element assigned to the given {@link Point}.</summary>
    /// <param name="el">- Reference to a {@link Point} object, that has to be updated.</param>
    abstract updatePoint: el: Point -> unit
    /// <summary>Changes the style of a {@link Point}. This is required because the point styles differ in what
    ...
    /// <param name="el">- Reference to a {@link Point} object, that's style is changed.</param>
    abstract changePointStyle: el: Point -> unit
    /// <summary>Draws a line on the {@link Board}.</summary>
    /// <param name="el">- Reference to a line object, that has to be drawn.</param>
    abstract drawLine: el: Line -> unit
    /// <summary>Updates visual appearance of the renderer element assigned to the given {@link Line}.</summary>
    /// <param name="el">- Reference to the {@link Line} object that has to be updated.</param>
    abstract updateLine: el: Line -> unit
    ...
    /// <param name="c1">- Coords of the first point of the line (after {@link Geometry#calcStraight}).</param>
    /// <param name="c2">- Coords of the second point of the line (after {@link Geometry#calcStraight}).</param>
    ...
    abstract getPositionArrowHead: el: Line * c1: Coords * c2: Coords * doHighlight: bool -> obj option
    ...
    abstract setLineCap: element: Line -> unit
    /// <summary>Creates a rendering node for ticks added to a line.</summary>
    /// <param name="el">- A arbitrary line.</param>
    abstract drawTicks: el: Line -> unit
    /// <summary>Update {@link Ticks} on a {@link Line}. This method is only a stub and has to be implemented
    /// in any descendant renderer class.</summary>
    /// <param name="element">- Reference of a ticks object that has to be updated.</param>
    abstract updateTicks: element: Ticks -> unit
    /// <summary>Draws a {@link Curve} on the {@link Board}.</summary>
    /// <param name="el">- Reference to a graph object, that has to be plotted.</param>
    abstract drawCurve: el: Curve -> unit
    /// <summary>Updates visual appearance of the renderer element assigned to the given {@link Curve}.</summary>
    /// <param name="el">- Reference to a {@link Curve} object, that has to be updated.</param>
    abstract updateCurve: el: Curve -> unit
    /// <summary>Draws a {@link Circle}</summary>
    /// <param name="el">- Reference to a {@link Circle} object that has to be drawn.</param>
    abstract drawEllipse: el: Circle -> unit
    /// <summary>Updates visual appearance of a given {@link Circle} on the {@link Board}.</summary>
    /// <param name="el">- Reference to a {@link Circle} object, that has to be updated.</param>
    abstract updateEllipse: el: Circle -> unit
    /// <summary>Draws a {@link Polygon} on the {@link Board}.</summary>
    /// <param name="el">- Reference to a Polygon object, that is to be drawn.</param>
    abstract drawPolygon: el: Polygon -> unit
    /// <summary>Updates properties of a {@link Polygon}'s rendering node.</summary>
    /// <param name="el">- Reference to a {@link Polygon} object, that has to be updated.</param>
    abstract updatePolygon: el: Polygon -> unit
    ...
    /// <summary>An internal text is a {@link Text} element which is drawn using only
    /// the given renderer but no HTML. This method is only a stub, the drawing
    /// is done in the special renderers.</summary>
    /// <param name="element">- Reference to a {@link Text} object</param>
    abstract drawInternalText: element: Text -> unit
    /// <summary>Updates visual properties of an already existing {@link Text} element.</summary>
    /// <param name="element">- Reference to an {@link Text} object, that has to be updated.</param>
    abstract updateInternalText: element: Text -> unit
    /// <summary>Displays a {@link Text} on the {@link Board} by putting a HTML div over it.</summary>
    /// <param name="el">- Reference to an {@link Text} object, that has to be displayed</param>
    abstract drawText: el: Text -> unit
    /// <summary>Updates visual properties of an already existing {@link Text} element.</summary>
    /// <param name="el">- Reference to an {@link Text} object, that has to be updated.</param>
    abstract updateText: el: Text -> unit
    ...
    /// <summary>Updates font-size, color and opacity propertiey and CSS style properties of a {@link Text} node.
    /// This function is also called by highlight() and nohighlight().</summary>
    /// <param name="el">- Reference to the {@link Text} object, that has to be updated.</param>
    abstract updateTextStyle: el: Text * doHighlight: bool -> unit
    /// <summary>Draws an {@link Image} on a board; This is just a template that has to be implemented by special
    /// renderers.</summary>
    /// <param name="element">- Reference to the image object that is to be drawn</param>
    abstract drawImage: element: Image -> unit
    /// <summary>Updates the properties of an {@link Image} element.</summary>
    /// <param name="el">- Reference to an {@link Image} object, that has to be updated.</param>
    abstract updateImage: el: Image -> unit
    ...
    abstract joinTransforms: el: GeometryElement * transformations: ResizeArray<obj option> -> ResizeArray<obj option>
    ...
    /// <param name="element">- A {@link Image} or {@link Text} object.</param>
    /// <param name="transformations">- An array of {@link Transformation} objects. This is usually the
    /// transformations property of the given element <tt>el</tt>.</param>
    abstract transformImage: element: U2<Image, Text> * transformations: ResizeArray<obj option> -> unit
    ...
    abstract updateImageURL: element: Image -> unit
    /// <summary>Updates CSS style properties of a {@link Image} node.
    ...
    /// <param name="el">- Reference to the {@link Image} object, that has to be updated.</param>
    abstract updateImageStyle: el: Text * doHighlight: bool -> unit
    ...
    /// {@link SVGRenderer#layer} or the <tt>z-index</tt> style property of the node in VMLRenderer.</param>
    ...
    abstract appendNodesToElement: element: GeometryElement * ``type``: string -> unit
    ...
    abstract makeArrows: element: GeometryElement -> unit
    ...
    abstract updateLinePrim: node: Node * p1x: float * p1y: float * p2x: float * p2y: float * board: Board -> unit
    ...
    abstract updatePathPrim: node: Node * pathString: string * board: Board -> unit
    ...
    abstract updatePathStringPoint: element: Point * size: float * ``type``: string -> unit
    /// Builds a path data string from a {@link Curve} element. Since the path data strings heavily depend on the
    ...
    /// Builds a path data string from a {@link Curve} element such that the curve looks like hand drawn. Since
    ...
    /// <param name="element">- A JSXGraph element of type {@link Polygon}</param>
    abstract updatePolygonPrim: node: Node * element: Polygon -> unit
    ...
    abstract display: element: GeometryElement * value: bool -> unit
    /// <summary>Shows a hidden element on the canvas; Only a stub, requires implementation in the derived renderer.
    /// 
    /// Please use AbstractRenderer#display instead</summary>
    /// <param name="element">- Reference to the object that has to appear.</param>
    abstract show: element: GeometryElement -> unit
    ...
    abstract hide: element: GeometryElement -> unit
    /// <summary>Sets the buffering as recommended by SVGWG. Until now only Opera supports this and will be ignored by other
    /// browsers. Although this feature is only supported by SVG we have this method in {@link AbstractRenderer}
    ...
    abstract setDashStyle: element: GeometryElement -> unit
    ...
    abstract setDraft: el: GeometryElement -> unit
    ...
    abstract removeDraft: el: GeometryElement -> unit
    ...
    abstract updateGradient: element: GeometryElement -> unit
    ...
    abstract setObjectTransition: element: GeometryElement * duration: float -> unit
    ...
    abstract setObjectFillColor: element: GeometryElement * color: string * opacity: float -> unit
    /// <summary>Changes an objects stroke color to the given color.</summary>
    /// <param name="element">- Reference of the {@link GeometryElement} that gets a new stroke
    /// color.</param>
    /// <param name="color">- Color value in a HTML compatible format, e.g. <strong>#00ff00</strong> or
    /// <strong>green</strong> for green.</param>
    /// <param name="opacity">- Opacity of the fill color. Must be between 0 and 1.</param>
    abstract setObjectStrokeColor: element: GeometryElement * color: string * opacity: float -> unit
    ...
    abstract setObjectStrokeWidth: element: GeometryElement * width: float -> unit
    ...
    abstract setShadow: element: GeometryElement -> unit
    ...
    abstract highlight: el: GeometryElement -> AbstractRenderer
    /// <summary>Uses the normal colors of an object, i.e. the opposite of {@link AbstractRenderer#highlight}.</summary>
    /// <param name="el">- Reference of the object that will get its normal colors.</param>
    abstract noHighlight: el: GeometryElement -> AbstractRenderer
    ...
    abstract drawZoomBar: board: Board * attr: obj option -> unit
...
type [<AllowNullLiteral>] Chart = class end
...
/// <li> rowHeight.
/// </ul>
type [<AllowNullLiteral>] Legend = class end
...
type [<AllowNullLiteral>] Curve =
    ...
    /// The curveType is set in {@link Curve#generateTerm} and used in {@link Curve#updateCurve}.
    ...
    /// Only parameter and plot are set directly. Polar is set with {@link GeometryElement#setAttribute} only.
...
/// which is just a wrapper for element {@link Curve} with {@link Curve#X}()
...
type [<AllowNullLiteral>] SplineStatic =
    [<Emit "new $0($1...)">] abstract Create: board: Board * parents: ResizeArray<obj option> * attributes: obj option -> Spline
...
type [<AllowNullLiteral>] Cardinalspline =
    ...
    /// arrays should be converted into {@link Points}.
...
type [<AllowNullLiteral>] CardinalsplineStatic =
    [<Emit "new $0($1...)">] abstract Create: board: Board * parents: ResizeArray<obj option> * attributes: obj option -> Cardinalspline
...
type [<AllowNullLiteral>] DerivativeStatic =
    [<Emit "new $0($1...)">] abstract Create: Parent: Curve -> Derivative

/// This element combines a given set of {@link Point} elements to a
...
type [<AllowNullLiteral>] GroupStatic =
    [<Emit "new $0($1...)">] abstract Create: board: Board * parents: ResizeArray<obj option> * attributes: obj option -> Group
...
/// This element is used to provide a constructor for arrow, which is just a wrapper for element {@link Line} with {@link Line#straightFirst}
...
/// This element is used to provide a constructor for an axis. It's strictly spoken just a wrapper for element {@link Line} with {@link Line#straightFirst}
...
type [<AllowNullLiteral>] Axis =
    ...
    abstract defaultTicks: Ticks with get, set
    /// Show / hide ticks.
    /// 
...
type [<AllowNullLiteral>] RadicalAxisStatic =
    [<Emit "new $0($1...)">] abstract Create: circle: Circle * circle: Circle -> RadicalAxis
...
type [<AllowNullLiteral>] Point =
    ...
    /// <li>number: truncate after "number digits" with toFixed();
    /// </ul>
...
type [<AllowNullLiteral>] PointStatic =
    [<Emit "new $0($1...)">] abstract Create: Point: obj * Transformation: Point_Transformation_Array -> Point
...
type [<AllowNullLiteral>] Glider =
    ...
    abstract startAnimation: direction: float * stepCount: float * delay: float -> CoordsElement
    /// Stop animation.
    abstract stopAnimation: unit -> CoordsElement

/// A glider is a point which lives on another geometric element like a line, circle, curve, turtle.
type [<AllowNullLiteral>] GliderStatic =
    [<Emit "new $0($1...)">] abstract Create: z_: obj * x_: obj * y_: obj * GlideObject: Number_Number_Number_GeometryElement -> Glider
...
type [<AllowNullLiteral>] RegularPolygonStatic =
    [<Emit "new $0($1...)">] abstract Create: p1: obj * p2: obj * n: Point_Point_Number -> RegularPolygon

/// Construct and handle texts.
/// 
/// The coordinates can be relative to the coordinates of an element
/// given in {@link Options#text.anchor}.
/// 
...
type [<AllowNullLiteral>] Text =
    ...
    /// <ol>
    /// <li> Options.text.cssStyle
    /// <li> Options.text.cssDefaultStyle
    /// <li> Options.text.cssClass
    /// </ol>
...
type [<AllowNullLiteral>] Label =
    ...
    /// The label anchor is determined by GeometryElement#label.position
...
type [<AllowNullLiteral>] Ticks =
    inherit Ticks
    /// A function that expects two {@link Coords}, the first one representing the coordinates of the
...
type [<AllowNullLiteral>] TicksStatic =
    [<Emit "new $0($1...)">] abstract Create: line: Line * distance: float -> Ticks
...
type [<AllowNullLiteral>] HatchStatic =
    [<Emit "new $0($1...)">] abstract Create: line: Line * numberofhashes: float -> Hatch
...
type [<AllowNullLiteral>] Turtle =
    ...
    abstract popTurtle: unit -> Turtle
    ...
    abstract lookTo: target: U2<float, ResizeArray<obj option>> -> Turtle
    ...
    abstract moveTo: target: ResizeArray<obj option> -> Turtle
    /// Alias for {@link Turtle#forward}
    abstract fd: unit -> unit
    /// Alias for {@link Turtle#back}
    abstract bk: unit -> unit
    /// Alias for {@link Turtle#left}
    abstract lt: unit -> unit
    /// Alias for {@link Turtle#right}
    abstract rt: unit -> unit
    /// Alias for {@link Turtle#penUp}
    abstract pu: unit -> unit
    /// Alias for {@link Turtle#penDown}
    abstract pd: unit -> unit
    /// Alias for {@link Turtle#hideTurtle}
    abstract ht: unit -> unit
    /// Alias for {@link Turtle#showTurtle}
    abstract st: unit -> unit
    /// Alias for {@link Turtle#clearScreen}
    abstract cs: unit -> unit
    /// Alias for {@link Turtle#pushTurtle}
    abstract push: unit -> unit
    /// Alias for {@link Turtle#popTurtle}
...
type [<AllowNullLiteral>] TurtleStatic =
    [<Emit "new $0($1...)">] abstract Create: board: Board * parents: ResizeArray<obj option> * attributes: obj option -> Turtle
...
type [<AllowNullLiteral>] ArcStatic =
    [<Emit "new $0($1...)">] abstract Create: p1: obj * p2: obj * p3: Point_Point_Point -> Arc
...
type [<AllowNullLiteral>] SemicircleStatic =
    [<Emit "new $0($1...)">] abstract Create: p1: obj * p2: Point_Point -> Semicircle
...
type [<AllowNullLiteral>] CircumcircleArcStatic =
    [<Emit "new $0($1...)">] abstract Create: p1: obj * p2: obj * p3: Point_Point_Point -> CircumcircleArc
...
type [<AllowNullLiteral>] MinorArcStatic =
    [<Emit "new $0($1...)">] abstract Create: p1: obj * p2: obj * p3: Point_Point_Point -> MinorArc
...
type [<AllowNullLiteral>] MajorArcStatic =
    [<Emit "new $0($1...)">] abstract Create: p1: obj * p2: obj * p3: Point_Point_Point -> MajorArc
...
type [<AllowNullLiteral>] OrthogonalprojectionStatic =
    [<Emit "new $0($1...)">] abstract Create: p: obj * l: Line_Point -> Orthogonalprojection
...
type [<AllowNullLiteral>] PerpendicularStatic =
    [<Emit "new $0($1...)">] abstract Create: l: obj * p: Line_Point -> Perpendicular
...
type [<AllowNullLiteral>] PerpendicularPointStatic =
    [<Emit "new $0($1...)">] abstract Create: p: obj * l: Line_Point -> PerpendicularPoint
...
type [<AllowNullLiteral>] PerpendicularSegmentStatic =
    [<Emit "new $0($1...)">] abstract Create: l: obj * p: Line_Point -> PerpendicularSegment
...
type [<AllowNullLiteral>] MidpointStatic =
    [<Emit "new $0($1...)">] abstract Create: p1: obj * p2: Point_Point * l: Line -> Midpoint
...
type [<AllowNullLiteral>] ParallelpointStatic =
    [<Emit "new $0($1...)">] abstract Create: p1: obj * p2: obj * p3: Point_Point_Point * l: obj * p: Line_Point -> Parallelpoint
...
type [<AllowNullLiteral>] ParallelStatic =
    [<Emit "new $0($1...)">] abstract Create: l: obj * p: Line_Point -> Parallel
...
type [<AllowNullLiteral>] ArrowparallelStatic =
    [<Emit "new $0($1...)">] abstract Create: l: obj * p: Line_Point -> Arrowparallel
...
type [<AllowNullLiteral>] Normal =
    inherit Line
    /// A helper point used to create a normal to a {@link Line} object. For normals to circles or curves this
...
type [<AllowNullLiteral>] BisectorStatic =
    [<Emit "new $0($1...)">] abstract Create: p1: obj * p2: obj * p3: Point_Point_Point -> Bisector
...
type [<AllowNullLiteral>] BisectorlinesStatic =
    [<Emit "new $0($1...)">] abstract Create: l1: obj * l2: Line_Line -> Bisectorlines
...
type [<AllowNullLiteral>] CircumcenterStatic =
    [<Emit "new $0($1...)">] abstract Create: p1: obj * p2: obj * p3: Point_Point_Point -> Circumcenter
...
type [<AllowNullLiteral>] IncenterStatic =
    [<Emit "new $0($1...)">] abstract Create: p1: obj * p2: obj * p3: Point_Point_Point -> Incenter
...
type [<AllowNullLiteral>] CircumcircleStatic =
    [<Emit "new $0($1...)">] abstract Create: p1: obj * p2: obj * p3: Point_Point_Point -> Circumcircle
...
type [<AllowNullLiteral>] IncircleStatic =
    [<Emit "new $0($1...)">] abstract Create: p1: obj * p2: obj * p3: Point_Point_Point -> Incircle
...
type [<AllowNullLiteral>] ReflectionStatic =
    [<Emit "new $0($1...)">] abstract Create: p: obj * l: U4<Point, Line, Curve, Polygon_Line> -> Reflection
...
type [<AllowNullLiteral>] MirrorelementStatic =
    [<Emit "new $0($1...)">] abstract Create: p1: obj * p2: U4<Point, Line, Curve, Ppolygon_Point> -> Mirrorelement
...
type [<AllowNullLiteral>] MirrorpointStatic =
    [<Emit "new $0($1...)">] abstract Create: p1: obj * p2: Point_Point -> Mirrorpoint
...
type [<AllowNullLiteral>] IntegralStatic =
    [<Emit "new $0($1...)">] abstract Create: i: obj * c: Array_Curve -> Integral
...
/// draws such a grid on the given board. It uses options given in {@link Options#grid}. This method does not
...
type [<AllowNullLiteral>] InequalityStatic =
    [<Emit "new $0($1...)">] abstract Create: l: Line -> Inequality
...
type [<AllowNullLiteral>] LocusStatic =
    [<Emit "new $0($1...)">] abstract Create: p: Point -> Locus
...
type [<AllowNullLiteral>] Sector =
    ...
    abstract point3: Point with get, set
    /// Defines the sectors orientation in case of circumCircleSectors.
    abstract point4: Point with get, set
...
type [<AllowNullLiteral>] SectorStatic =
    [<Emit "new $0($1...)">] abstract Create: p1: obj * p2: obj * p1: Point_Point_Point -> Sector
...
type [<AllowNullLiteral>] CircumcircleSectorStatic =
    [<Emit "new $0($1...)">] abstract Create: p1: obj * p2: obj * p1: Point_Point_Point -> CircumcircleSector
...
type [<AllowNullLiteral>] MinorSectorStatic =
    [<Emit "new $0($1...)">] abstract Create: p1: obj * p2: obj * p3: Point_Point_Point -> MinorSector
...
type [<AllowNullLiteral>] MajorSectorStatic =
    [<Emit "new $0($1...)">] abstract Create: p1: obj * p2: obj * p3: Point_Point_Point -> MajorSector
...
type [<AllowNullLiteral>] Angle =
    ...
    abstract pointsquare: Point with get, set
    ...
    /// one.
    abstract dot: Point with get, set
...
type [<AllowNullLiteral>] AngleStatic =
    [<Emit "new $0($1...)">] abstract Create: p1: obj * p2: obj * p1: Point_Point_Point * line: obj * JXG: obj * Line_JXG: obj * Line_array: obj * : obj * number_array: obj * : obj * number: obj -> Angle
...
type [<AllowNullLiteral>] NonReflexAngleStatic =
    [<Emit "new $0($1...)">] abstract Create: p1: obj * p2: obj * p3: Point_Point_Point -> NonReflexAngle
...
type [<AllowNullLiteral>] ReflexAngleStatic =
    [<Emit "new $0($1...)">] abstract Create: p1: obj * p2: obj * p3: Point_Point_Point -> ReflexAngle
...
type [<AllowNullLiteral>] Slider =
    ...
    /// The text element to the right of the slider, indicating its current value.
    abstract label: Text with get, set
    ...
    /// A line on top of the baseline, indicating the slider's progress.
    abstract highline: Line with get, set
...
type [<AllowNullLiteral>] SlopetriangleStatic =
    [<Emit "new $0($1...)">] abstract Create: t: Line * li: obj * JXG: obj * Line_JXG: obj * Point: obj -> Slopetriangle
...
module JXG =
    ...
    type [<AllowNullLiteral>] BoardStatic =
        [<Emit "new $0($1...)">] abstract Create: container: string * renderer: AbstractRenderer * id: string * origin: Coords * zoomX: float * zoomY: float * unitX: float * unitY: float * canvasWidth: float * canvasHeight: float * attributes: obj option -> Board
    ...
    type [<AllowNullLiteral>] Chart =
        ...
        abstract drawLine: x: ResizeArray<obj option> * y: ResizeArray<obj option> * attributes: obj option -> Curve
        /// <summary>Create line chart that consists of a natural spline curve
        /// defined by two data arrays.</summary>
        /// <param name="x">- Array of x-coordinates</param>
        /// <param name="y">- Array of y-coordinates</param>
        /// <param name="attributes">- Javascript object containing attributes like colors</param>
        abstract drawSpline: x: ResizeArray<obj option> * y: ResizeArray<obj option> * attributes: obj option -> Curve
        ...
        /// <param name="y">- Array of y-coordinates</param>
        /// <param name="attributes">- Javascript object containing attributes like colors</param>
        abstract drawFit: x: ResizeArray<obj option> * y: ResizeArray<obj option> * attributes: obj option -> Curve
        ...
        /// by the user.
        abstract updateDataArray: unit -> Chart
        /// Stores the SVG (or VML) rendering node for the element. This enables low-level
        /// access to SVG nodes. The properties of such an SVG node can then be changed
        /// by calling setAttribute(). Note that there are a few elements which consist
        /// of more than one SVG nodes:
    ...
    type [<AllowNullLiteral>] Circle =
        ...
        /// only set if method equals 'pointLine'. Do not set this parameter directly as it will break JSXGraph's update system.
        abstract circle: Circle with get, set
        ...
        abstract setRadius: r: U3<string, float, (ResizeArray<obj option> -> obj option)> -> Circle
        ...
        /// Use {@link Circle#Radius}.
        abstract getRadius: unit -> unit
        /// <summary>Add transformations to this circle.</summary>
        /// <param name="transform">- Either one {@link Transformation} or an array of {@link Transformation}s.</param>
        abstract addTransform: transform: U2<Transformation, ResizeArray<obj option>> -> Circle
    ...
    /// line, or circle).
    type [<AllowNullLiteral>] CircleStatic =
        [<Emit "new $0($1...)">] abstract Create: board: Board * ``method``: string * par1: Point * par2: U3<Point, Line, Circle> * attributes: obj option -> Circle

    /// A composition is a simple container that manages none or more {@link GeometryElement}s.
    type [<AllowNullLiteral>] Composition =
        ...
        /// See {@link GeometryElement#setAttribute} for further description, valid parameters and return values.
        ...
        /// See {@link GeometryElement#setParents} for further description, valid parameters and return values.
        ...
        /// See {@link GeometryElement#prepareUpdate} for further description, valid parameters and return values.
        ...
        /// See {@link GeometryElement#updateRenderer} for further description, valid parameters and return values.
        ...
        /// See {@link GeometryElement#update} for further description, valid parameters and return values.
        abstract update: unit -> unit
        /// Invokes fullUpdate for every stored element with a fullUpdate method and hands over the given arguments.
        /// See {@link GeometryElement#fullUpdate} for further description, valid parameters and return values.
        ...
        /// See {@link GeometryElement#highlight} for further description, valid parameters and return values.
        ...
        /// See {@link GeometryElement#noHighlight} for further description, valid parameters and return values.
    ...
    type [<AllowNullLiteral>] CoordsStatic =
        [<Emit "new $0($1...)">] abstract Create: ``method``: float * coordinates: ResizeArray<obj option> * board: Board -> Coords
    ...
    type [<AllowNullLiteral>] Curve =
        ...
        /// It is set in {@link Curve#updateCurve}.
        ...
        /// the method {@link Curve#updateDataArray}.
        ...
        abstract qdt: Math.Quadtree with get, set
        /// Gives the default value of the left bound for the curve.
        /// May be overwritten in {@link Curve#generateTerm}.
        ...
        /// <param name="t">- A number between {@link Curve#minX} and {@link Curve#maxX}.</param>
        ...
        /// for the arrays {@link Curve#dataX} and {@link Curve#dataY}. It
        /// is used in {@link Curve#updateCurve}. Default is an empty method, can
        ...
        /// <summary>Updates the data points of a parametric curve. This version is used if {@link Curve#doadvancedplot} is <tt>false</tt>.</summary>
        ...
        /// <summary>Updates the data points of a parametric curve. This version is used if {@link Curve#doadvancedplot} is <tt>true</tt>.
        /// Since 0.99 this algorithm is deprecated. It still can be used if {@link Curve#doadvancedplotold} is <tt>true</tt>.</summary>
        /// <param name="mi">- Left bound of curve</param>
        /// <param name="ma">- Right bound of curve</param>
        abstract updateParametricCurveOld: mi: float * ma: float -> Curve
        /// <summary>Updates the data points of a parametric curve. This version is used if {@link Curve#doadvancedplot} is <tt>true</tt>.</summary>
        /// <param name="mi">- Left bound of curve</param>
        /// <param name="ma">- Right bound of curve</param>
        ...
        /// Before using it, {@link Curve#updateTransformMatrix} has to be called.
    ...
    /// Curves are the common object for function graphs, parametric curves, polar curves, and data plots.
    type [<AllowNullLiteral>] CurveStatic =
        [<Emit "new $0($1...)">] abstract Create: board: U2<string, Board> * parents: ResizeArray<obj option> * attributes: obj option -> Curve


    /// Constructs a new GeometryElement object.
    type [<AllowNullLiteral>] GeometryElementStatic =
        [<Emit "new $0($1...)">] abstract Create: board: Board * attributes: obj option * ``type``: float * oclass: float -> GeometryElement
    ...
    type [<AllowNullLiteral>] Group =
        ...
        abstract setRotationCenter: ``object``: U2<Point, string> -> Group
        ...
        /// the rotation center of the group {@see Group#setRotationCenter}.</summary>
        /// <param name="objects">- Array of {@link Point} or arbitrary number of {@link Point} elements.</param>
        abstract setRotationPoints: objects: U2<ResizeArray<obj option>, Point> -> Group
        ...
        /// the rotation center of the group {@see Group#setRotationCenter}.</summary>
        /// <param name="point">- {@link Point} element.</param>
        abstract addRotationPoint: point: Point -> Group
        /// <summary>Removes the rotation property from a point of the group.</summary>
        /// <param name="point">- {@link Point} element.</param>
        abstract removeRotationPoint: point: Point -> Group
        ...
        /// <param name="objects">- Array of {@link Point} or arbitrary number of {@link Point} elements.
        /// By default, all points of the group are translation points.</param>
        abstract setTranslationPoints: objects: U2<ResizeArray<obj option>, Point> -> Group
        ...
        /// <param name="point">- {@link Point} element.</param>
        abstract addTranslationPoint: point: Point -> Group
        /// <summary>Removes the translation property from a point of the group.</summary>
        /// <param name="point">- {@link Point} element.</param>
        abstract removeTranslationPoint: point: Point -> Group
        ...
        /// an array of length two, or a function returning an array of length two.</param>
        abstract setScaleCenter: ``object``: U2<Point, string> -> Group
        ...
        /// By default, all points of the group are translation points.</param>
        abstract setScalePoints: objects: U2<ResizeArray<obj option>, Point> * direction: string -> Group
        ...
        abstract addScalePoint: point: Point * direction: string -> Group
        /// <summary>Removes the scaling property from a point of the group.</summary>
        /// <param name="point">- {@link Point} element.</param>
        abstract removeScalePoint: point: Point -> Group
        abstract setProperty: unit -> unit

    /// Creates a new instance of Group.
    type [<AllowNullLiteral>] GroupStatic =
        [<Emit "new $0($1...)">] abstract Create: board: Board * id: string * name: string * objects: ResizeArray<obj option> * attributes: obj option -> Group
    ...
    type [<AllowNullLiteral>] Image =
        ...
        abstract setSize: unit -> GeometryElement
    ...
    /// an URL: function(){ return 'xxx.png; }.
    type [<AllowNullLiteral>] ImageStatic =
        [<Emit "new $0($1...)">] abstract Create: board: U2<string, Board> * coordinates: ResizeArray<obj option> * attributes: obj option * url: U2<string, (ResizeArray<obj option> -> obj option)> * size: ResizeArray<obj option> -> Image
    ...
    type [<AllowNullLiteral>] Line =
        ...
        abstract point1: Point with get, set
        /// Endpoint of the line. Just like {@link Line.point1} you shouldn't write this field directly.
        abstract point2: Point with get, set
        /// Array of ticks storing all the ticks on this line. Do not set this field directly and use
        /// {@link Line#addTicks} and {@link Line#removeTicks} to add and remove ticks to and from the line.
        ...
        /// <param name="transform">- Either one {@link Transformation} or an array of
        /// {@link Transformation}s.</param>
        abstract addTransform: transform: U2<Transformation, ResizeArray<obj option>> -> Line
        ...
        /// See {@link Line#X} for a detailed description.</summary>
        /// <param name="t">- Parameter running from 0 to 1.</param>
        abstract Y: t: float -> float
        /// <summary>Treat the line as parametric curve in homogeneous coordinates.
        /// See {@link Line#X} for a detailed description.</summary>
        ...
        abstract addTicks: ticks: Ticks -> string
        ...
        abstract removeTicks: tick: Ticks -> unit
        /// Controls if updates are necessary
        abstract needsUpdate: bool with get, set
        /// If element is in two dimensional real space this is true, else false.
        abstract isReal: bool with get, set
    ...
    type [<AllowNullLiteral>] Point =
        ...
        abstract update: unit -> unit
        /// Applies the transformations of the element to {@link Point#baseElement}.
        /// Point transformations are relative to a base element.
        abstract updateTransform: unit -> CoordsElement
        ...
        /// <param name="f">- String which determines the face of the point. See {@link GeometryElement#face} for a list of available faces.</param>
    ...
    /// all kind of points like free points, gliders, and intersection points.
    type [<AllowNullLiteral>] PointStatic =
        [<Emit "new $0($1...)">] abstract Create: board: U2<string, Board> * coordinates: ResizeArray<obj option> * attributes: obj option -> Point
    ...
    type [<AllowNullLiteral>] Polygon =
        ...
        /// the object completely you should use {@link Board#removeObject}.
        abstract remove: unit -> unit
        /// <summary>Finds the index to a given point reference.</summary>
        /// <param name="p">- Reference to an element of type {@link Point}</param>
        abstract findPoint: p: Point -> unit
        ...
        abstract addPoints: p: Point -> Polygon
        ...
        abstract insertPoints: idx: float * p: Point -> Polygon
        /// <summary>Removes given set of vertices from the polygon</summary>
        /// <param name="p">- Arbitrary number of vertices as {@link Point} elements or index numbers</param>
        abstract removePoints: p: Point -> Polygon
        /// <summary>Moves the polygon by the difference of two coordinates.</summary>
        /// <param name="method">- The type of coordinates used here. Possible values are {@link COORDS_BY_USER} and {@link COORDS_BY_SCREEN}.</param>
        /// <param name="coords">- coordinates in screen/user units</param>
        /// <param name="oldcoords">- previous coordinates in screen/user units</param>
        abstract setPositionDirectly: ``method``: float * coords: ResizeArray<obj option> * oldcoords: ResizeArray<obj option> -> Polygon
        ...
        /// Calls {@link Polygon#sutherlandHodgman}.</summary>
        /// <param name="polygon">- Polygon which will be clipped.</param>
        abstract intersect: polygon: Polygon -> ResizeArray<obj option>
        /// Controls if updates are necessary
        abstract needsUpdate: bool with get, set
        /// If element is in two dimensional real space this is true, else false.
        abstract isReal: bool with get, set
    ...
    /// Creates a new instance of Polygon.
    type [<AllowNullLiteral>] PolygonStatic =
        [<Emit "new $0($1...)">] abstract Create: board: Board * vertices: ResizeArray<obj option> * attributes: obj option -> Polygon
    ...
    type [<AllowNullLiteral>] Text =
        ...
        /// Defines new content.
        abstract setText: text: U2<string, (ResizeArray<obj option> -> obj option)> -> Text
        /// Recompute the width and the height of the text box.
        /// Updates the array {@link Text#size} with pixel values.
        /// The result may differ from browser to browser
        /// by some pixels.
        /// In canvas an old IEs we use a very crude estimation of the dimensions of
        /// the textbox.
        /// JSXGraph needs {@link Text#size} for applying rotations in IE and
        /// for aligning text.
        ...
        abstract setAutoPosition: unit -> Text
        /// Controls if updates are necessary
        abstract needsUpdate: bool with get, set
        /// Controls if this element can be dragged. In GEONExT only
        /// free points and gliders can be dragged.
    ...
    /// MathJax, HTML and GEONExT syntax can be handled.
    type [<AllowNullLiteral>] TextStatic =
        [<Emit "new $0($1...)">] abstract Create: board: U2<string, Board> * coordinates: ResizeArray<obj option> * attributes: obj option * content: U2<string, (ResizeArray<obj option> -> obj option)> -> Text
    ...
    type [<AllowNullLiteral>] Ticks =
        ...
        /// <param name="coords">- coordinates in screen/user units</param>
        /// <param name="oldcoords">- previous coordinates in screen/user units</param>
        abstract setPositionDirectly: ``method``: float * coords: ResizeArray<obj option> * oldcoords: ResizeArray<obj option> -> Ticks
        ...
        abstract update: unit -> Ticks
        /// Uses the boards renderer to update the arc.
        abstract updateRenderer: unit -> Ticks
        /// Controls if updates are necessary
        abstract needsUpdate: bool with get, set
        /// The string used with {@link Board#create}
        abstract elType: string with get, set
    ...
    /// Creates ticks for an axis.
    type [<AllowNullLiteral>] TicksStatic =
        [<Emit "new $0($1...)">] abstract Create: line: Line * ticks: U2<float, ResizeArray<obj option>> * attributes: obj option -> Ticks

    /// A transformation consists of a 3x3 matrix, i.e. it is a projective transformation.
    type [<AllowNullLiteral>] Transformation =
        /// Updates the numerical data for the transformation, i.e. the entry of the subobject matrix.
        abstract update: unit -> Transform
        ...
        abstract setMatrix: board: Board * ``type``: string * ``params``: ResizeArray<obj option> * x: obj * y: ResizeArray<obj option> * scale_x: obj * scale_y: ResizeArray<obj option> * line: obj * : obj * point_pair: obj * : obj * : obj * apply: obj -> unit

    /// A transformation consists of a 3x3 matrix, i.e. it is a projective transformation.
    type [<AllowNullLiteral>] TransformationStatic =
        [<Emit "new $0($1...)">] abstract Create: board: Board * ``type``: string * ``params``: obj option -> Transformation
...
type [<AllowNullLiteral>] JSXGraphStatic =
    ...
    /// <param name="attributes">- An object that sets some of the board properties. Most of these properties can be set via Options.</param>
    abstract initBoard: box: string * attributes: JSXGraphStaticInitBoardAttributes -> Board
    ...
    abstract loadBoardFromFile: box: string * file: string * format: string * ?attributes: obj -> Board
    ...
    /// <param name="format">- containing the file format: 'Geonext' or 'Intergeo'.</param>
    abstract loadBoardFromString: box: string * string: string * format: string * ?attributes: obj -> Board
...
type [<AllowNullLiteral>] Complex =
    ...
    abstract add: unit -> Complex
    /// Subtract another complex number from this complex number.
    abstract sub: unit -> Complex
    /// Multiply another complex number to this complex number.
    abstract mult: unit -> Complex
    /// Divide this complex number by the given complex number.
    abstract div: unit -> Complex
    /// Conjugate a complex number in place.
    abstract conj: unit -> Complex
...
module Math =
    ...
    module Geometry =
        ...
        type [<AllowNullLiteral>] IExports =
            ...
            abstract angleBisector: A: Point * B: Point * C: Point * ?board: obj -> Coords
            ...
            /// <param name="board">- Reference to the board</param>
            abstract reflection: line: Line * point: Point * ?board: obj -> Coords
            ...
            /// <param name="board">- Reference to the board</param>
            abstract rotation: rotpoint: Point * point: Point * phi: float * ?board: Board -> Coords
            ...
            /// <param name="board">- Reference to the board</param>
            abstract perpendicular: line: Line * point: Point * ?board: Board -> ResizeArray<obj option>
            ...
            /// <param name="board">- Reference to the board</param>
            abstract circumcenter: point1: Point * point2: Point * point3: Point * ?board: Board -> Coords
            ...
            /// <param name="p">- An array containing {@link Point}, {@link Coords}, and/or arrays.</param>
            abstract sortVertices: p: ResizeArray<obj option> -> ResizeArray<obj option>
            /// Signed triangle area of the three points given.
            abstract signedTriangle: p1: U3<Point, Coords, ResizeArray<obj option>> * p2: U3<Point, Coords, ResizeArray<obj option>> * p3: U3<Point, Coords, ResizeArray<obj option>> -> float
            ...
            /// <param name="points">- An array containing {@link Point}, {@link Coords}, and/or arrays.</param>
            ...
            abstract calcStraight: el: Line * point1: Coords * point2: Coords * margin: float -> obj option
            /// <summary>A line can be a segment, a straight, or a ray. so it is not always delimited by point1 and point2.
            /// 
            ...
            /// <param name="point2">- Coordinates of the point where line drawing ends. This value is calculated and set
            /// by this method.</param>
            abstract calcLineDelimitingPoints: el: Line * point1: Coords * point2: Coords -> unit
            ...
            abstract isSameDir: p1: Coords * p2: Coords * i1: Coords * i2: Coords -> bool
            ...
            abstract isSameDirection: start: Coords * p: Coords * s: Coords -> bool
            /// <summary>Generate the function which computes the coordinates of the intersection point.
            /// Primarily used in {@link Point#createIntersectionPoint}.</summary>
            /// <param name="board">- object</param>
            abstract intersectionFunction: board: Board -> (ResizeArray<obj option> -> obj option)
            ...
            /// <param name="board">- Reference to the board.</param>
            abstract meet: el1: ResizeArray<obj option> * el2: ResizeArray<obj option> * i: float * board: obj option -> Coords
            ...
            /// <param name="margin">- optional margin, to avoid the display of the small sides of lines.</param>
            abstract meetLineBoard: line: ResizeArray<obj option> * board: Board * margin: float -> ResizeArray<obj option>
            ...
            /// <param name="board">- Reference to the board.</param>
            abstract meetLineLine: l1: ResizeArray<obj option> * l2: ResizeArray<obj option> * i: float * board: Board -> Coords
            ...
            /// <param name="board">- Reference to a board.</param>
            abstract meetLineCircle: lin: ResizeArray<obj option> * circ: ResizeArray<obj option> * i: float * board: Board -> Coords
            ...
            /// i==1: use the negative square root.</param>
            /// <param name="board">- Reference to the board.</param>
            abstract meetCircleCircle: circ1: ResizeArray<obj option> * circ2: ResizeArray<obj option> * i: float * board: Board -> Coords
            ...
            abstract meetCurveCurve: c1: Curve * c2: Curve * nr: float * t2ini: float * ?board: Board * ?``method``: string -> Coords
            ...
            /// {@link Math.Geometry.meetCurveLineDiscrete}.
            /// If higher precision is needed, {@link Math.Geometry.meetCurveLineContinuous}
            ...
            abstract meetCurveLine: nr: float * ?board: Board * alwaysIntersect: bool -> Coords
            /// <summary>Intersection of line and curve, continuous case.
            /// Finds the nr-the intersection point
            /// Uses {@link Math.Geometry.meetCurveLineDiscrete} as a first approximation.
            /// A more exact solution is then found with {@link Math.Numerics.root}.</summary>
            /// <param name="cu">- Curve</param>
            /// <param name="li">- Line</param>
            /// <param name="nr">- Will return the nr-th intersection point.</param>
            abstract meetCurveLineContinuous: cu: Curve * li: Line * nr: float * board: Board -> Coords
            ...
            abstract meetCurveLineDiscrete: cu: Curve * li: Line * nr: float * board: Board * testSegment: bool -> Coords
            ...
            abstract meetCurveRedBlueSegments: red: Curve * blue: Curve * nr: float -> unit
            ...
            abstract meetBezierCurveRedBlueSegments: red: Curve * blue: Curve * nr: float -> ResizeArray<obj option>
            ...
            /// <param name="board">- Reference to the board</param>
            abstract projectPointToCircle: circle: Circle * ?board: Board -> Coords
            ...
            /// <param name="board">- Reference to a board.</param>
            abstract projectPointToLine: point: Point * line: Line * ?board: Board -> Coords
            ...
            /// {@link Curve} to a given coordinate array.</summary>
            ...
            abstract projectCoordsToBeziersegment: pos: ResizeArray<obj option> * curve: Curve * start: float -> ResizeArray<obj option>
            /// <summary>Calculates the coordinates of the projection of a given point on a given curve.
            /// Uses {@link Math.Geometry.projectCoordsToCurve}.</summary>
            /// <param name="point">- Point to project.</param>
            /// <param name="curve">- Curve on that the point is projected.</param>
            /// <param name="board">- Reference to a board.</param>
            abstract projectPointToCurve: point: Point * curve: Curve * ?board: Board -> Coords
            ...
            /// <param name="curve">- Curve on that the point is projected.</param>
            /// <param name="board">- Reference to a board.</param>
            abstract projectCoordsToCurve: x: float * y: float * t: float * curve: Curve * ?board: Board -> Coords
            ...
            abstract projectCoordsToPolygon: p: ResizeArray<obj option> * pol: Polygon -> ResizeArray<obj option>
            /// <summary>Calculates the coordinates of the projection of a given point on a given turtle. A turtle consists of
            /// one or more curves of curveType 'plot'. Uses {@link Math.Geometry.projectPointToCurve}.</summary>
            /// <param name="point">- Point to project.</param>
            /// <param name="turtle">- on that the point is projected.</param>
            /// <param name="board">- Reference to a board.</param>
            abstract projectPointToTurtle: point: Point * turtle: Turtle * ?board: Board -> Coords
            ...
            abstract projectPointToPoint: point: Point * dest: Point -> Coords
            abstract projectPointToBoard: point: U2<Point, Coords> * ?board: Board -> unit
    ...
    module Numerics =
        ...
        type [<AllowNullLiteral>] IExports =
            ...
            /// Internal method used in {@link Math.Numerics.GaussKronrod15},
            /// {@link Math.Numerics.GaussKronrod21},
            /// {@link Math.Numerics.GaussKronrod31}.</summary>
            /// <param name="interval">- The integration interval, e.g. [0, 3].</param>
            /// <param name="f">- A function which takes one argument of type number and returns a number.</param>
            ...
            /// is an alias for {@link Math.Numerics.fzero}</summary>
            /// <param name="f">- We search for a solution of f(x)=0.</param>
            ...
            abstract generalizedNewton: c1: Curve * c2: Curve * t1ini: float * t2ini: float -> Coords
            ...
            /// <param name="p">- Array of Points</param>
            ...
            /// <param name="x">- x values of knots</param>
            /// <param name="y">- y values of knots</param>
            /// <param name="F">- Second derivatives at knots, calculated by {@link Math.Numerics.splineDef}</param>
            ...
            /// <param name="points">- Array consisting of Points.</param>
            ...
            /// an array of {@link Point}s or {@link Coords}.
            ...
            /// <param name="points">- Array consisting of 3*k+1 {@link Points}.
            ...
            /// see {@link Curve#updateCurve}
            /// and {@link Curve#hasPoint}.</summary>
            ...
            /// to use the method Curve.Value() of this element instead.</summary>
            ...
            /// <param name="pts">- Array of {@link Coords}</param>
            ...
            /// pts (consisting of type Coords).</summary>
            /// <param name="pts">- Array of {@link Coords}</param>
    ...
    module Poly =
        ...
        type [<AllowNullLiteral>] MonomialStatic =
            [<Emit "new $0($1...)">] abstract Create: ring: Math.Poly.Ring * coefficient: float * exponents: ResizeArray<obj option> -> Monomial
            /// Creates a deep copy of the monomial.
            abstract copy: unit -> Math.Poly.Monomial
            /// Print the monomial.
        ...
        type [<AllowNullLiteral>] PolynomialStatic =
            [<Emit "new $0($1...)">] abstract Create: ring: Math.Poly.Ring * str: string -> Polynomial
            ...
            abstract addSubMonomial: m: Math.Poly.Monomial * factor: float -> unit
            ...
            abstract add: mp: U2<Math.Poly.Polynomial, Math.Poly.Monomial> -> unit
            /// Subtracts another polynomial or monomial from this one and merges them by checking for the
            /// signature of each new monomial in the existing monomials.
            abstract sub: mp: U2<Math.Poly.Polynomial, Math.Poly.Monomial> -> unit
            /// Creates a deep copy of the polynomial.
            abstract copy: unit -> Math.Poly.Polynomial
    ...
    module Statistics =
        ...
        type [<AllowNullLiteral>] IExports =
            ...
            /// <summary>Weighted mean value is basically the same as {@link Math.Statistics.mean} but here the values
            ...
            /// points than least squares regression in {@link Math.Numerics.regressionPolynomial}.</summary>
            /// <param name="coords">- Array of {@link Coords}.</param>
    ...
    module Symbolic =
        ...
        type [<AllowNullLiteral>] IExports =
            ...
            abstract generateSymbolicCoordinatesPartial: board: Board * element: GeometryElement * variable: string * append: string -> float
            ...
            abstract clearSymbolicCoordinates: board: Board -> unit
            ...
            abstract generatePolynomials: board: Board * element: GeometryElement * generateCoords: bool -> ResizeArray<obj option>
            ...
            abstract geometricLocusByGroebnerBase: board: Board * point: Point -> ResizeArray<obj option>
...
/// please use {@link JessieCode#parse}. For code snippets like single expressions use {@link JessieCode#snippet}.
...
module GeonextParser =
    ...
    type [<AllowNullLiteral>] IExports =
        ...
        abstract replaceNameById: term: string * board: Board * ?jc: bool -> string
        ...
        abstract geonext2JS: term: string * board: Board -> string
        ...
        /// <param name="board">- Reference to a board</param>
        abstract findDependencies: me: GeometryElement * term: string * ?board: Board -> unit
        ...
        /// <param name="term">- Expression in GEONExT syntax</param>
        abstract gxt2jc: term: string * board: Board -> string
...
type [<AllowNullLiteral>] JessieCode =
    ...
    /// lhs flag, used by JessieCode#replaceNames
    ...
    /// Looks up an {@link GeometryElement} by its id.
    abstract getElementById: id: string -> GeometryElement
    ...
    abstract setProp: o: U2<Point, Text> * what: string * value: obj option -> unit
    ...
    /// {@link JessieCode#replaceNames} to the name of the element (if not empty).
    ...
    abstract X: e: U2<Point, Text> -> float
    /// This is used as the global Y() function.
    abstract Y: e: U2<Point, Text> -> float
    /// This is used as the global V() function.
    abstract V: e: U2<Glider, Slider> -> float
    /// This is used as the global L() function.
    abstract L: e: Line -> float
    /// This is used as the global dist() function.
    abstract dist: p1: Point * p2: Point -> float
    /// + operator implementation
    abstract add: a: U3<float, ResizeArray<obj option>, Point> * b: U3<float, ResizeArray<obj option>, Point> -> U2<float, ResizeArray<obj option>>
    /// - operator implementation
    abstract sub: a: U3<float, ResizeArray<obj option>, Point> * b: U3<float, ResizeArray<obj option>, Point> -> U2<float, ResizeArray<obj option>>
    /// unary - operator implementation
    abstract neg: a: U3<float, ResizeArray<obj option>, Point> -> U2<float, ResizeArray<obj option>>
    ...
    abstract del: element: GeometryElement -> unit
...
module Dump =
    ...
    type [<AllowNullLiteral>] IExports =
        ...
        abstract addMarkers: board: Board * markers: U2<ResizeArray<obj option>, string> * values: ResizeArray<obj option> -> unit
        /// Removes markers from every element on the board.
        abstract deleteMarkers: board: Board * markers: U2<ResizeArray<obj option>, string> -> unit
        ...
        /// <summary>Eliminate default values given by {@link Options} from the attributes object.</summary>
        ...
        /// sub-objects of the {@link Board#options} structure.</param>
        ...
        abstract prepareAttributes: board: Board * obj: GeometryElement -> obj option
        /// Generate a save-able structure with all elements. This is used by {@link Dump#toJessie} and
        /// {@link Dump#toJavaScript} to generate the script.
        abstract dump: board: Board -> ResizeArray<obj option>
        ...
        /// {@link toJSON} or {@link Dump.toJCAN} are used.</param>
        ...
        abstract toJessie: board: Board -> string
        /// Saves the construction in <tt>board</tt> to JavaScript.
        abstract toJavaScript: board: Board -> string
...
module EventEmitter =
    ...
    type [<AllowNullLiteral>] IExports =
        ...
        /// <pre>@borrows EventEmitter#on as this.on</pre>
...
module Util =
    ...
    module Base64 =
        ...
        type [<AllowNullLiteral>] IExports =
            ...
            /// <param name="utf8">- In case this parameter is true {@link Util.UTF8.decode} will be applied to
